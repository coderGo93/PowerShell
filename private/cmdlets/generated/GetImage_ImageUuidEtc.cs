namespace Nutanix.Powershell.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Image_ImageUuidEtc")]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.IImageIntentResponse))]
    public class GetImage_ImageUuidEtc : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetImage_ImageUuidEtc</returns>
        public Nutanix.Powershell.Cmdlets.GetImage_ImageUuidEtc Clone()
        {
        ...
        /// <returns>an instance of GetImage_ImageUuidEtc.</returns>
        public static Nutanix.Powershell.Cmdlets.GetImage_ImageUuidEtc FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetImage_ImageUuidEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>returns a new instance of the <see cref="GetImage_ImageUuidEtc" /> cmdlet</returns>
        public static Nutanix.Powershell.Cmdlets.GetImage_ImageUuidEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetImage_ImageUuidEtc" /> cmdlet class.
        /// </summary>
        public GetImage_ImageUuidEtc()
        {
        }
        ...
        internal GetImage_ImageUuidEtc(Carbon.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using (NoSynchronizationContext)
            {
                ...
                await this.Client.GetImage(Uuid, onOK, onDefault, this, Pipeline, Credential);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetImage_ImageUuidEtc" /> as a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
