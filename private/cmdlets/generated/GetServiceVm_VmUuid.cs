namespace Nutanix.Powershell.Cmdlets
{
    ...
    public class GetServiceVm_VmUuid : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetServiceVm_VmUuid</returns>
        public Nutanix.Powershell.Cmdlets.GetServiceVm_VmUuid Clone()
        {
        ...
        /// <returns>an instance of GetServiceVm_VmUuid.</returns>
        public static Nutanix.Powershell.Cmdlets.GetServiceVm_VmUuid FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetServiceVm_VmUuid(json) : null;
        }
        /// <summary>
        ...
        /// <returns>returns a new instance of the <see cref="GetServiceVm_VmUuid" /> cmdlet</returns>
        public static Nutanix.Powershell.Cmdlets.GetServiceVm_VmUuid FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetServiceVm_VmUuid" /> cmdlet class.
        /// </summary>
        public GetServiceVm_VmUuid()
        {
        }
        ...
        internal GetServiceVm_VmUuid(Carbon.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetServiceVm_VmUuid" /> as a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
