namespace Nutanix.Powershell.Cmdlets
{
    ...
    public class RemoveSubnet_SubnetUuid : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveSubnet_SubnetUuid</returns>
        public Nutanix.Powershell.Cmdlets.RemoveSubnet_SubnetUuid Clone()
        {
        ...
        /// <returns>an instance of RemoveSubnet_SubnetUuid.</returns>
        public static Nutanix.Powershell.Cmdlets.RemoveSubnet_SubnetUuid FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RemoveSubnet_SubnetUuid(json) : null;
        }
        /// <summary>
        ...
        /// <returns>returns a new instance of the <see cref="RemoveSubnet_SubnetUuid" /> cmdlet</returns>
        public static Nutanix.Powershell.Cmdlets.RemoveSubnet_SubnetUuid FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                // work
                if (ShouldProcess($"Call remote 'deleteSubnet' operation"))
                {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveSubnet_SubnetUuid" /> cmdlet class.
        /// </summary>
        public RemoveSubnet_SubnetUuid()
        {
        }
        ...
        internal RemoveSubnet_SubnetUuid(Carbon.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="RemoveSubnet_SubnetUuid" /> as a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
