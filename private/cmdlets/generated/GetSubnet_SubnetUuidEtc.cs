namespace Nutanix.Powershell.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Subnet_SubnetUuidEtc")]
    ...
    public class GetSubnet_SubnetUuidEtc : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetSubnet_SubnetUuidEtc</returns>
        public Nutanix.Powershell.Cmdlets.GetSubnet_SubnetUuidEtc Clone()
        {
        ...
        /// <returns>an instance of GetSubnet_SubnetUuidEtc.</returns>
        public static Nutanix.Powershell.Cmdlets.GetSubnet_SubnetUuidEtc FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetSubnet_SubnetUuidEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>returns a new instance of the <see cref="GetSubnet_SubnetUuidEtc" /> cmdlet</returns>
        public static Nutanix.Powershell.Cmdlets.GetSubnet_SubnetUuidEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetSubnet_SubnetUuidEtc" /> cmdlet class.
        /// </summary>
        public GetSubnet_SubnetUuidEtc()
        {
        }
        ...
        internal GetSubnet_SubnetUuidEtc(Carbon.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using (NoSynchronizationContext)
            {
                ...
                await this.Client.GetSubnet(Uuid, onOK, onNotFound, onDefault, this, Pipeline, Credential);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetSubnet_SubnetUuidEtc" /> as a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
