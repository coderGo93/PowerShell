namespace Nutanix.Powershell.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"Subnet_SubnetUuidApiVersionMetadataSpecExpanded", SupportsShouldProcess = true)]
    ...
    public class SetSubnet_SubnetUuidApiVersionMetadataSpecExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of SetSubnet_SubnetUuidApiVersionMetadataSpecExpanded</returns>
        public Nutanix.Powershell.Cmdlets.SetSubnet_SubnetUuidApiVersionMetadataSpecExpanded Clone()
        {
        ...
        /// <returns>
        /// returns a new instance of the <see cref="SetSubnet_SubnetUuidApiVersionMetadataSpecExpanded" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.SetSubnet_SubnetUuidApiVersionMetadataSpecExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetSubnet_SubnetUuidApiVersionMetadataSpecExpanded" /> cmdlet class.
        /// </summary>
        public SetSubnet_SubnetUuidApiVersionMetadataSpecExpanded()
        {
        }
        ...
        internal SetSubnet_SubnetUuidApiVersionMetadataSpecExpanded(Carbon.Json.JsonObject json)
        {
