namespace Nutanix.Powershell.Cmdlets
{
    ...
    public class GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrder : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Nutanix.Powershell.Models.IVmListMetadata _getEntitiesRequest;
        ...
        /// <returns>
        /// a duplicate instance of GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrder
        /// </returns>
        public Nutanix.Powershell.Cmdlets.GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrder Clone()
        {
        ...
        /// <returns>an instance of GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrder.</returns>
        public static Nutanix.Powershell.Cmdlets.GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrder FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrder(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrder" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrder FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrder" /> cmdlet class.
        /// </summary>
        public GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrder()
        {
        }
        ...
        internal GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrder(Carbon.Json.JsonObject json)
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                // work
                if (ShouldProcess($"Call remote 'getVms' operation"))
                {
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrder" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
