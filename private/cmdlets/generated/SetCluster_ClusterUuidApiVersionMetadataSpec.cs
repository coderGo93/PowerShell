namespace Nutanix.Powershell.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"Cluster_ClusterUuidApiVersionMetadataSpec", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.IClusterIntentResponse))]
    public class SetCluster_ClusterUuidApiVersionMetadataSpec : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Nutanix.Powershell.Models.IClusterIntentInput _body;

        /// <summary>An intentful representation of a cluster</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "An intentful representation of a cluster", ValueFromPipeline = true)]
        public Nutanix.Powershell.Models.IClusterIntentInput Body
        {
            get
            {
                return this._body;
        ...
        /// <returns>a duplicate instance of SetCluster_ClusterUuidApiVersionMetadataSpec</returns>
        public Nutanix.Powershell.Cmdlets.SetCluster_ClusterUuidApiVersionMetadataSpec Clone()
        {
        ...
        /// <returns>an instance of SetCluster_ClusterUuidApiVersionMetadataSpec.</returns>
        public static Nutanix.Powershell.Cmdlets.SetCluster_ClusterUuidApiVersionMetadataSpec FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new SetCluster_ClusterUuidApiVersionMetadataSpec(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="SetCluster_ClusterUuidApiVersionMetadataSpec" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.SetCluster_ClusterUuidApiVersionMetadataSpec FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetCluster_ClusterUuidApiVersionMetadataSpec" /> cmdlet class.
        /// </summary>
        public SetCluster_ClusterUuidApiVersionMetadataSpec()
        {
        }
        ...
        internal SetCluster_ClusterUuidApiVersionMetadataSpec(Carbon.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="SetCluster_ClusterUuidApiVersionMetadataSpec" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
