namespace Nutanix.Powershell.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Remove-Image.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"Image_ImageUuid", SupportsShouldProcess = true)]
    ...
    public class RemoveImage_ImageUuid : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveImage_ImageUuid</returns>
        public Nutanix.Powershell.Cmdlets.RemoveImage_ImageUuid Clone()
        {
        ...
        /// <returns>an instance of RemoveImage_ImageUuid.</returns>
        public static Nutanix.Powershell.Cmdlets.RemoveImage_ImageUuid FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RemoveImage_ImageUuid(json) : null;
        }
        /// <summary>
        ...
        /// <returns>returns a new instance of the <see cref="RemoveImage_ImageUuid" /> cmdlet</returns>
        public static Nutanix.Powershell.Cmdlets.RemoveImage_ImageUuid FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveImage_ImageUuid" /> cmdlet class.
        /// </summary>
        public RemoveImage_ImageUuid()
        {
        }
        ...
        /// <returns>
        /// a serialized instance of <see cref="RemoveImage_ImageUuid" /> as a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
