namespace Nutanix.Powershell.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Set-Cluster.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"Cluster_ClusterUuidApiVersionMetadataSpecExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.IClusterIntentResponse))]
    public class SetCluster_ClusterUuidApiVersionMetadataSpecExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Nutanix.Powershell.Models.IClusterIntentInput _body = new Nutanix.Powershell.Models.ClusterIntentInput();

        /// <summary>An intentful representation of a cluster</summary>
        private Nutanix.Powershell.Models.IClusterIntentInput Body
        {
            get
            {
                return this._body;
        ...
        public string ClusterName
        {
            set
            {
                Body.Spec = Body.Spec ?? new Nutanix.Powershell.Models.Cluster();
        ...
        public Nutanix.Powershell.Models.IClusterConfigSpec ClusterResourcesConfig
        {
            ...
            {
                Body.Spec = Body.Spec ?? new Nutanix.Powershell.Models.Cluster();
                Body.Spec.Resources = Body.Spec.Resources ?? new Nutanix.Powershell.Models.ClusterResources();
                Body.Spec.Resources.Config = value;
            }
        }
        ...
        public Nutanix.Powershell.Models.IClusterNetwork ClusterResourcesNetwork
        {
            set
            {
                Body.Spec = Body.Spec ?? new Nutanix.Powershell.Models.Cluster();
                Body.Spec.Resources = Body.Spec.Resources ?? new Nutanix.Powershell.Models.ClusterResources();
                Body.Spec.Resources.Network = value;
            }
        }
        ...
        public string[] ClusterResourcesRuntimeStatusList
        {
            set
            {
                Body.Spec = Body.Spec ?? new Nutanix.Powershell.Models.Cluster();
                Body.Spec.Resources = Body.Spec.Resources ?? new Nutanix.Powershell.Models.ClusterResources();
                Body.Spec.Resources.RuntimeStatusList = value;
            }
        }
        ...
        /// <returns>a duplicate instance of SetCluster_ClusterUuidApiVersionMetadataSpecExpanded</returns>
        public Nutanix.Powershell.Cmdlets.SetCluster_ClusterUuidApiVersionMetadataSpecExpanded Clone()
        {
        ...
        /// <returns>an instance of SetCluster_ClusterUuidApiVersionMetadataSpecExpanded.</returns>
        public static Nutanix.Powershell.Cmdlets.SetCluster_ClusterUuidApiVersionMetadataSpecExpanded FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new SetCluster_ClusterUuidApiVersionMetadataSpecExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="SetCluster_ClusterUuidApiVersionMetadataSpecExpanded" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.SetCluster_ClusterUuidApiVersionMetadataSpecExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                // work
                if (ShouldProcess($"Call remote 'updateCluster' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            using (NoSynchronizationContext)
            {
                ...
                await this.Client.UpdateCluster(Uuid, Body, onAccepted, onDefault, this, Pipeline, Credential);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetCluster_ClusterUuidApiVersionMetadataSpecExpanded" /> cmdlet class.
        /// </summary>
        public SetCluster_ClusterUuidApiVersionMetadataSpecExpanded()
        {
        }
        ...
        internal SetCluster_ClusterUuidApiVersionMetadataSpecExpanded(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _uuid = If(json?.PropertyT<Carbon.Json.JsonString>("Uuid"), out var __jsonUuid) ? (string)__jsonUuid : (string)Uuid;
            _body = If(json?.PropertyT<Carbon.Json.JsonObject>("Body"), out var __jsonBody) ? Nutanix.Powershell.Models.ClusterIntentInput.FromJson(__jsonBody) : Body;
        }
        ...
        /// <returns>
        /// a serialized instance of <see cref="SetCluster_ClusterUuidApiVersionMetadataSpecExpanded" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
        ...
        /// <param name="response">the body result as a <see cref="Nutanix.Powershell.Models.IClusterIntentResponse" /> from the remote
        /// call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onAccepted(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Nutanix.Powershell.Models.IClusterIntentResponse> response)
        {
            using (NoSynchronizationContext)
            {
                // onAccepted - response for 202 / application/json
                // (await response) // should be Nutanix.Powershell.Models.IClusterIntentResponse
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Nutanix.Powershell.Models.IClusterStatus" /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
