namespace Nutanix.Powershell.Cmdlets
{
    ...
    public class GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrderExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public string SortOrder
        {
            set
            {
                GetEntitiesRequest.SortOrder = value;
            }
        }
        /// <summary>
        ...
        /// class.
        /// </summary>
        public GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrderExpanded()
        {
        }
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetServiceVm_VmsFilterKindLengthOffsetSortAttributeSortOrderExpanded" /> as a <see
