namespace Nutanix.Powershell.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Image_ImagesFilterKindLengthOffsetSortAttributeSortOrder", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.IImageListIntentResponse))]
    public class GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrder : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="GetEntitiesRequest" /> property.</summary>
        private Nutanix.Powershell.Models.IImageListMetadata _getEntitiesRequest;
        ...
        public Nutanix.Powershell.Models.IImageListMetadata GetEntitiesRequest
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrder
        /// </returns>
        public Nutanix.Powershell.Cmdlets.GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrder Clone()
        {
        ...
        /// <returns>an instance of GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrder.</returns>
        public static Nutanix.Powershell.Cmdlets.GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrder FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrder(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrder" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrder FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrder" /> cmdlet class.
        /// </summary>
        public GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrder()
        {
        }
        ...
        internal GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrder(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _getEntitiesRequest = If(json?.PropertyT<Carbon.Json.JsonObject>("GetEntitiesRequest"), out var __jsonGetEntitiesRequest) ? Nutanix.Powershell.Models.ImageListMetadata.FromJson(__jsonGetEntitiesRequest) : GetEntitiesRequest;
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using (NoSynchronizationContext)
            {
                ...
                await this.Client.GetImages(GetEntitiesRequest, onOK, onDefault, this, Pipeline, Credential);
