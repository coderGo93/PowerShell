namespace Nutanix.Powershell.Cmdlets
{
    ...
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.ISubnetStatus))]
    public class SetSubnet_SubnetUuidApiVersionMetadataSpec : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of SetSubnet_SubnetUuidApiVersionMetadataSpec</returns>
        public Nutanix.Powershell.Cmdlets.SetSubnet_SubnetUuidApiVersionMetadataSpec Clone()
        {
        ...
        /// <returns>an instance of SetSubnet_SubnetUuidApiVersionMetadataSpec.</returns>
        public static Nutanix.Powershell.Cmdlets.SetSubnet_SubnetUuidApiVersionMetadataSpec FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new SetSubnet_SubnetUuidApiVersionMetadataSpec(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="SetSubnet_SubnetUuidApiVersionMetadataSpec" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.SetSubnet_SubnetUuidApiVersionMetadataSpec FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                // work
                if (ShouldProcess($"Call remote 'updateSubnet' operation"))
                {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetSubnet_SubnetUuidApiVersionMetadataSpec" /> cmdlet class.
        /// </summary>
        public SetSubnet_SubnetUuidApiVersionMetadataSpec()
        {
        }
        ...
        internal SetSubnet_SubnetUuidApiVersionMetadataSpec(Carbon.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="SetSubnet_SubnetUuidApiVersionMetadataSpec" /> as a <see cref="Carbon.Json.JsonNode"
        /// />.
        /// </returns>
