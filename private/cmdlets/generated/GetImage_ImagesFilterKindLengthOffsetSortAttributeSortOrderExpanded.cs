namespace Nutanix.Powershell.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Get-Image.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Image_ImagesFilterKindLengthOffsetSortAttributeSortOrderExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Nutanix.Powershell.Models.IImageListIntentResponse))]
    public class GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrderExpanded : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Nutanix.Powershell.Models.IImageListMetadata _getEntitiesRequestBody = new Nutanix.Powershell.Models.ImageListMetadata();

        /// <summary>
        /// All api calls that return a list will have this metadata block as input
        /// </summary>
        private Nutanix.Powershell.Models.IImageListMetadata GetEntitiesRequestBody
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrderExpanded
        /// </returns>
        public Nutanix.Powershell.Cmdlets.GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrderExpanded Clone()
        {
        ...
        /// <returns>
        /// an instance of GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrderExpanded.
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrderExpanded FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrderExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrderExpanded" /> cmdlet
        /// </returns>
        public static Nutanix.Powershell.Cmdlets.GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrderExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrderExpanded" /> cmdlet
        /// class.
        /// </summary>
        public GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrderExpanded()
        {
        }
        ...
        internal GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrderExpanded(Carbon.Json.JsonObject json)
        {
            // deserialize the contents
            _getEntitiesRequestBody = If(json?.PropertyT<Carbon.Json.JsonObject>("GetEntitiesRequestBody"), out var __jsonGetEntitiesRequestBody) ? Nutanix.Powershell.Models.ImageListMetadata.FromJson(__jsonGetEntitiesRequestBody) : GetEntitiesRequestBody;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            try
            {
                ...
                // work
                if (ShouldProcess($"Call remote 'GetImages' operation"))
                {
        ...
        {
            _getEntitiesRequestBody.Kind = "subnet";
            using (NoSynchronizationContext)
            {
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetImage_ImagesFilterKindLengthOffsetSortAttributeSortOrderExpanded" /> as a <see
        ...
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Nutanix.Powershell.Models.IImageListIntentResponse" /> from the remote
        /// call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
